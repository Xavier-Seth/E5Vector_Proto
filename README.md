...
- Install [Poppler for Windows](https://github.com/oschwartz10612/poppler-windows/releases) and add the `bin/` folder to PATH  
...
- Example test:
  ```bash
  curl -X POST -F "file=@path/to/your-document.pdf" http://127.0.0.1:5000/extract-and-classify
  ```
